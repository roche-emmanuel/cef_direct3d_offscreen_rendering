...
//
// $hash=6fa33b483a6c6c34f8dc12fe0a17b7dead12d1d4$
//
...
int CEF_CALLBACK
render_handler_use_shared_handle(struct _cef_render_handler_t* self) {
  ...
  // Execute
  bool _retval = CefRenderHandlerCppToC::Get(self)->UseSharedHandle();
...
void* CEF_CALLBACK
render_handler_get_shared_handle(struct _cef_render_handler_t* self){
  DCHECK(self);
  if (!self)
    return NULL;

  // Execute
  void* handle = CefRenderHandlerCppToC::Get(self)->GetSharedHandle();
...
CefRenderHandlerCppToC::CefRenderHandlerCppToC() {
  GetStruct()->use_shared_handle = render_handler_use_shared_handle;
  GetStruct()->get_shared_handle = render_handler_get_shared_handle;
